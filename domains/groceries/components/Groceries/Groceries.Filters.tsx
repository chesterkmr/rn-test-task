...
export const GroceriesFilters = ({
  onFilterChange,
  defaultFilters,
}: GroceriesFiltersProps) => {
  const { filters } = useGroceries();
                ...
                >
                  ...
                  >
                    <SelectInput
                      ...
                      value={
                        statusOptions.find(
                          (option) => option.value === internalFilters.status
                        )?.label || "All"
                      }
...
GroceriesFilters.displayName = "GroceriesFilters";
